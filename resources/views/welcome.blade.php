...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ====== GAMES SECTION ====== */
        .games-section {
            background: linear-gradient(160deg, #FFF0F8 0%, #F0F4FF 100%);
        }
        ...
        /* ====== REWARDS ====== */
        .rewards-section {
            background: linear-gradient(160deg, #FFFBF0 0%, #FFF0FF 100%);
        }
        ...
        .lb-item.top1 {
            background: linear-gradient(135deg, rgba(255, 230, 109, 0.3), rgba(249, 115, 22, 0.15));
            border: 2px solid rgba(255, 200, 0, 0.4);
        }

        .lb-item.top2 {
            background: linear-gradient(135deg, rgba(209, 213, 219, 0.4), rgba(156, 163, 175, 0.15));
            border: 2px solid rgba(200, 200, 200, 0.4);
        }

        .lb-item.top3 {
            background: linear-gradient(135deg, rgba(205, 127, 50, 0.2), rgba(180, 100, 20, 0.1));
            border: 2px solid rgba(180, 120, 50, 0.3);
        }
        ...
        @media (max-width: 640px) {
            .nav-links a:not(.btn-join):not(.btn-login) {
                display: none;
            }
...
<body>
    ...
    <main>
        ...
        <section class="hero">
            ...
            <p>TimePass is your ultimate social playground — play addictive games, vibe with friends, and stack up real
                rewards every single day.</p>
        ...
        <section class="features-section" id="features">
            <div class="container">
                <div class="reveal">
                    ...
                    <p class="section-sub">From gaming tournaments to real-time chat — we've packed in all the fun you
                        can handle.</p>
                </div>
                ...
                <div class="features-grid">
                    <div class="feat-card reveal" style="--c1:#FF6B6B;--c2:#FF8E53;" tabindex="0">
                        ...
                        <div class="feat-sub">Quizzes, puzzles, arcade games and live multiplayer battles — always
                            something new.</div>
                    </div>
                    <div class="feat-card reveal" style="--c1:#4ECDC4;--c2:#3B82F6;" tabindex="0">
                        <div class="feat-icon">💬</div>
                        <div class="feat-text">Real-Time Chat</div>
                        <div class="feat-sub">DM friends, group chats, voice notes, fun stickers and meme-ready GIFs.
                        </div>
                    </div>
                    <div class="feat-card reveal" style="--c1:#A855F7;--c2:#EC4899;" tabindex="0">
                        <div class="feat-icon">📸</div>
                        <div class="feat-text">Social Feed</div>
                        <div class="feat-sub">Share your wins, moments and highlights. React, comment and go viral.
                        </div>
                    </div>
                    <div class="feat-card reveal" style="--c1:#FFE66D;--c2:#F97316;" tabindex="0">
                        <div class="feat-icon">🏆</div>
                        <div class="feat-text">Real Rewards</div>
                        <div class="feat-sub">Earn coins every day. Redeem for gift cards, cash, premium badges and
                            more.</div>
                    </div>
        ...
        <section class="games-section" id="games">
            <div class="container">
                <div class="reveal">
                    ...
                    <p class="section-sub">Jump into a game instantly — no download needed. Compete, earn and climb the
                        leaderboard.</p>
                </div>
                ...
                <div class="games-grid">
                    ...
                    <div class="game-card reveal">
                        ...
                        <div class="game-info">
                            ...
                            <div class="game-meta">
                                <span class="live-badge" style="background:#F97316;"><span
                                        class="live-dot"></span>HOT</span>
                    ...
                    <div class="game-card reveal">
                        ...
                        <div class="game-info">
                            ...
                            <div class="game-meta">
                                <span class="live-badge" style="background:#6B7280;"><span
                                        class="live-dot"></span>SOON</span>
        ...
        <section class="social-section" id="social">
            <div class="container">
                <div class="reveal">
                    ...
                    <p class="section-sub">Share your wins, chat with friends, join communities and never miss a
                        moment.</p>
                </div>
                ...
                <div class="social-layout">
                    ...
                    <div class="feed-preview">
                        <div class="post-card reveal">
                            <div class="post-header">
                                <div class="post-avatar" style="background:linear-gradient(135deg,#FF6B6B,#FF8E53);">R
                                </div>
                                <div>
                            ...
                            <div class="post-body">Just hit 10,000 coins! 🎉 Brain Quiz is literally addictive. Who
                                wants to battle me? 🧠⚡</div>
                        ...
                        <div class="post-card reveal">
                            <div class="post-header">
                                <div class="post-avatar" style="background:linear-gradient(135deg,#A855F7,#EC4899);">P
                                </div>
                                <div>
                            ...
                            <div class="post-body">Redeemed my coins for a ₹500 Amazon voucher 😍 THIS APP IS REAL!!
                                Don't sleep on TimePass!!</div>
                            <div class="post-actions">
                        ...
                        <div class="post-card reveal">
                            <div class="post-header">
                                <div class="post-avatar" style="background:linear-gradient(135deg,#4ECDC4,#3B82F6);">A
                                </div>
                                <div>
                            ...
                            <div class="post-body">Reached Level 50 🎊 Anyone else in the top 100? Drop your rank below
                                👇</div>
                            <div class="post-actions">
                    ...
                    <div class="social-features">
                        <div class="social-feat-card reveal">
                            <div class="social-feat-icon"
                                style="background:linear-gradient(135deg,#FF6B6B22,#FF8E5322);">💌</div>
                        ...
                        <div class="social-feat-card reveal">
                            <div class="social-feat-icon"
                                style="background:linear-gradient(135deg,#A855F722,#EC489922);">👥</div>
                            <div class="social-feat-text">
                        ...
                        <div class="social-feat-card reveal">
                            <div class="social-feat-icon"
                                style="background:linear-gradient(135deg,#4ECDC422,#3B82F622);">📣</div>
                            <div class="social-feat-text">
                                <h4>Communities</h4>
                        ...
                        <div class="social-feat-card reveal">
                            <div class="social-feat-icon"
                                style="background:linear-gradient(135deg,#10B98122,#4ECDC422);">🔔</div>
                            <div class="social-feat-text">
                                <h4>Activity Feed</h4>
                        ...
                        <div class="social-feat-card reveal">
                            <div class="social-feat-icon"
                                style="background:linear-gradient(135deg,#FFE66D22,#F9731622);">🎙️</div>
                            <div class="social-feat-text">
                                <h4>Live Rooms</h4>
        ...
        <section class="rewards-section" id="rewards">
            <div class="container">
                <div class="reveal">
                    ...
                    <p class="section-sub">Every game you play, every streak you keep — it all adds up. Redeem for real
                        rewards.</p>
                </div>
            ...
            <div class="container">
                <div style="display:flex;gap:48px;flex-wrap:wrap;align-items:flex-start;">
                    <div class="reveal" style="flex:1;min-width:260px;">
                        ...
                        <a href="#" class="btn-hero-primary" style="margin-top:24px;display:inline-flex;">View
                            Full Board →</a>
                    </div>
                    ...
                    <div class="lb-list" style="flex:1.4;min-width:280px;">
                        <div class="lb-item top1 reveal">
                            ...
                            <div>
                                <div class="lb-name">Aryan_Gamer</div>
                                <div class="lb-sub">Level 50 · 18 games played</div>
                            </div>
                        ...
                        <div class="lb-item top2 reveal">
                            ...
                            <div>
                                <div class="lb-name">PriyaVibes</div>
                                <div class="lb-sub">Level 44 · 14 games played</div>
                            </div>
                        ...
                        <div class="lb-item top3 reveal">
                            ...
                            <div>
                                <div class="lb-name">RahulX99</div>
                                <div class="lb-sub">Level 38 · 12 games played</div>
                            </div>
                        ...
                        <div class="lb-item reveal">
                            ...
                            <div>
                                <div class="lb-name">Sreyoshi22</div>
                                <div class="lb-sub">Level 35 · 10 games played</div>
                            </div>
                        ...
                        <div class="lb-item reveal">
                            ...
                            <div>
                                <div class="lb-name">Mohit_Pro</div>
                                <div class="lb-sub">Level 31 · 9 games played</div>
                            </div>
        ...
        <footer>
            <div class="footer-inner">
                <div>
                    ...
                    <p style="margin-bottom:14px;line-height:1.6;">Your social gaming paradise. Play, connect, earn —
                        every single day. 🎮</p>
                    <div style="display:flex;gap:10px;margin-top:8px;">
                        <a href="#"
                            style="width:34px;height:34px;border-radius:10px;background:rgba(255,255,255,0.1);display:flex;align-items:center;justify-content:center;color:white;font-size:0.95rem;"><i
    ...
    <script>
        ...
        (function() {
            ...
            const l1 = new THREE.PointLight(0xFF6B6B, 2, 20);
            l1.position.set(4, 4, 4);
            scene.add(l1);
            const l2 = new THREE.PointLight(0x4ECDC4, 2, 20);
            l2.position.set(-4, -4, 3);
            scene.add(l2);
            const l3 = new THREE.PointLight(0xA855F7, 1.5, 20);
